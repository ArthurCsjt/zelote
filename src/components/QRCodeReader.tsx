      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center justify-between">
            ...
            <span className="text-xs bg-green-500/20 text-green-700 dark:text-green-400 font-bold px-2 py-0.5 rounded border border-green-500/40">
              Leitura Contínua
            </span>
          </DialogTitle>
          <p className="text-xs text-muted-foreground">
            Aponte a câmera para os QR Codes. O modal continuará aberto para escaneamento sequencial. Clique em <strong>Cancelar</strong> quando terminar.
          </p>
        </DialogHeader>
