    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <GlassCard className="p-4">
        ...
        <Calendar
          ...
          className="w-full p-0 flex justify-center" // Adicionado flex justify-center para centralizar
          locale={ptBR} // ADICIONANDO LOCALE AQUI
          classNames={{
            months: "flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0 w-full", // Adicionado w-full
            month: "space-y-4 w-full", // Adicionado w-full
