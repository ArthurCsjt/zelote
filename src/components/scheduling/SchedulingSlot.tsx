...
export const SchedulingSlot: React.FC<SchedulingSlotProps> = ({
        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <div className={cn(
                "h-full min-h-[4rem] border-[3px] border-dashed border-zinc-400 dark:border-zinc-600 bg-zinc-300 dark:bg-zinc-700 rounded-xl",
  ...
  const content = (
    <div className={cn(
      "h-full min-h-[4rem] p-1.5 border-3 transition-all flex flex-col gap-1.5 rounded-xl",
      isFull
          ...
          <TooltipProvider key={res.id}>
            <Tooltip>
              <TooltipTrigger asChild>
                <div
                  className={cn(
                    "w-full flex-1 flex items-center justify-center text-[8px] sm:text-[10px] leading-tight font-black uppercase truncate px-1 sm:px-1.5 py-1.5 sm:py-2 border-[1px] border-black text-center transition-all rounded-lg",
