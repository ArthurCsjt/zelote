...
export function ReturnForm({ onReturnSuccess, initialChromebookId, initialDeviceIds }: ReturnFormProps) {
  ...
  const handleConfirmReturnSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (successCount > 0) {
        const remaining = userActiveLoans.filter(l => !deviceIds.includes(l.chromebook_id));
    ...
    <form onSubmit={handleConfirmReturn} className="space-y-6 relative">
      ...
      <div className="grid md:grid-cols-2 gap-3 relative z-10">
        ...
        <div className="flex flex-col gap-6 h-full min-w-0">
          ...
          <div className="border-2 md:border-4 border-amber-500 bg-amber-100 dark:bg-amber-950/20 shadow-[3px_3px_0px_0px_rgba(245,158,11,0.3)] md:shadow-[6px_6px_0px_0px_rgba(245,158,11,0.3)] border-l-6 md:border-l-[12px] flex-1 p-0 overflow-hidden min-w-0 w-full max-w-full">
          ...
          {/* ═══ SEÇÃO 2: OBSERVAÇÕES ═══ */}
          <div className="border-2 md:border-4 border-gray-500 bg-gray-100 dark:bg-gray-950/20 shadow-[3px_3px_0px_0px_rgba(107,114,128,0.3)] md:shadow-[6px_6px_0px_0px_rgba(107,114,128,0.3)] border-l-6 md:border-l-[12px] p-0 overflow-hidden w-full max-w-full">
        ...
        <div className="space-y-6 min-w-0 w-full max-w-full">
          ...
          <div className="border-2 md:border-4 border-violet-500 bg-violet-100 dark:bg-violet-950/20 shadow-[3px_3px_0px_0px_rgba(139,92,246,0.3)] md:shadow-[6px_6px_0px_0px_rgba(139,92,246,0.3)] border-l-6 md:border-l-[12px] p-0 overflow-hidden min-w-0 w-full max-w-full">
