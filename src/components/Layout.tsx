...
import { User, LogOut, ArrowLeft, Download } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden md:flex items-center space-x-2 text-sm bg-gray-50 rounded-full px-3 py-1.5">
                <User className="w-4 h-4 text-gray-500" />
                <span className="text-gray-700 selectable-text">
                  {user?.email?.substring(0, 20)}...
                </span>
              </div>
              <button 
                onClick={logout}
                className="flex items-center space-x-1 text-sm text-gray-600 hover:text-gray-900 transition-colors duration-200 bg-gray-50 hover:bg-gray-100 rounded-full px-3 py-1.5 touch-manipulation"
              >
