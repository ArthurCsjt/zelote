        ...
        <div className="neo-brutal-card p-5">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-black uppercase tracking-tight text-foreground">AGENDAMENTO DE CHROMEBOOKS</h2>
            ...
            <ToggleGroup type="single" value={viewMode} onValueChange={(v: 'weekly' | 'monthly') => v && handleViewModeChange(v)} className="border-3 border-foreground/20 bg-background p-1">
              <ToggleGroupItem value="weekly" aria-label="Visualização Semanal" className={cn("h-10 px-4 font-bold uppercase text-xs tracking-wide rounded-none transition-all", viewMode === 'weekly' ? "bg-primary text-primary-foreground shadow-[2px_2px_0px_0px_hsl(var(--foreground)/0.3)]" : "hover:bg-muted")}>
                <CalendarDays className="h-4 w-4 mr-2" />
                Semanal
              </ToggleGroupItem>
              <ToggleGroupItem value="monthly" aria-label="Visualização Mensal" className={cn("h-10 px-4 font-bold uppercase text-xs tracking-wide rounded-none transition-all", viewMode === 'monthly' ? "bg-primary text-primary-foreground shadow-[2px_2px_0px_0px_hsl(var(--foreground)/0.3)]" : "hover:bg-muted")}>
        ...
        <div className="neo-brutal-card p-4">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <nav className="flex items-center gap-3">
              <Button variant="outline" size="icon" onClick={() => handleDateChange('prev')} disabled={isLoading} className="h-10 w-10 border-3 border-foreground/20 rounded-none hover:bg-muted transition-all hover:shadow-[2px_2px_0px_0px_hsl(var(--foreground)/0.2)] hover:-translate-x-0.5 hover:-translate-y-0.5">
              ...
              <Button variant="outline" size="icon" onClick={() => handleDateChange('next')} disabled={isLoading} className="h-10 w-10 border-3 border-foreground/20 rounded-none hover:bg-muted transition-all hover:shadow-[2px_2px_0px_0px_hsl(var(--foreground)/0.2)] hover:-translate-x-0.5 hover:-translate-y-0.5">
            ...
            <div className="flex items-center gap-3 px-4 py-2 border-3 border-success/30 bg-success/5">
              ...
              {isLoadingTotal ? <Loader2 className="h-5 w-5 animate-spin text-muted-foreground" /> : <span className="text-lg font-black text-success">
