...
const Index = () => {
  ...
  const [currentView, setCurrentView] = useState<'menu' | 'registration' | 'dashboard' | 'inventory' | 'loan' | 'audit' | 'intelligent-reports'>('menu');
  ...
  const renderCurrentView = () => {
    switch (currentView) {
      ...
      case 'audit':
        return <div>Auditoria temporariamente desabilitada</div>;
      default:
