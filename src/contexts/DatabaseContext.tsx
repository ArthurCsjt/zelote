...
interface DatabaseContextType {
  loading: boolean;
  createChromebook: (data: ChromebookData) => Promise<Chromebook | null>;
  getChromebooks: () => Promise<Chromebook[]>;
  getChromebooksByStatus: (status: Chromebook['status']) => Promise<Chromebook[]>;
  updateChromebook: (id: string, data: Partial<ChromebookData>) => Promise<boolean>;
  deleteChromebook: (id: string) => Promise<boolean>;
  syncChromebookStatus: (chromebookId: string) => Promise<string | null>;
  createLoan: (data: LoanFormData) => Promise<Loan | null>;
  bulkCreateLoans: (loanDataList: LoanFormData[]) => Promise<{ successCount: number, errorCount: number }>;
  getActiveLoans: () => Promise<LoanHistoryItem[]>;
  getLoanHistory: () => Promise<LoanHistoryItem[]>;
  createReturn: (loanId: string, data: ReturnFormData & { notes?: string }) => Promise<Return | null>;
  returnChromebookById: (chromebookId: string, data: ReturnFormData) => Promise<boolean>;
  bulkReturnChromebooks: (chromebookIds: string[], data: ReturnFormData & { notes?: string }) => Promise<{ successCount: number, errorCount: number }>;
  forceReturnLoan: (loan: LoanHistoryItem) => Promise<boolean>;
  createStudent: (data: StudentData) => Promise<any>;
  updateStudent: (id: string, data: Partial<StudentData>) => Promise<boolean>;
  bulkInsertStudents: (students: StudentData[]) => Promise<boolean>;
  deleteAllStudents: () => Promise<boolean>;
  createTeacher: (data: TeacherData) => Promise<any>;
  updateTeacher: (id: string, data: Partial<TeacherData>) => Promise<boolean>;
  createStaff: (data: StaffData) => Promise<any>;
  updateStaff: (id: string, data: Partial<StaffData>) => Promise<boolean>;
  deleteUserRecord: (id: string, userType: UserType) => Promise<boolean>;
}
  ...
  const forceReturnLoan = useCallback(async (loan: LoanHistoryItem): Promise<boolean> => {
    ...
    try {
      ...
      if (cbError || !chromebookData) {
          ...
          await syncChromebookStatus(chromebookData.chromebook_id);
      }
